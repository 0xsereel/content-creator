...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/sereel/config.toml'
...
image_style = _cfg.get("image_style", {})
logo = _cfg.get("logo", {
    "enabled": False,
    "path": "",
    "width": 120,
...
project_name = _cfg.get("project_name", "Sereel")
project_description = _cfg.get(
    "project_description",
    "<a href='https://sereel.com'>https://sereel.com</a>"
